...
No se pudo ejecutar Python en este entorno porque el intérprete no está instalado o no está disponible en la variable PATH. El código y las pruebas quedan listos para validarse con Python 3.10 o superior.
